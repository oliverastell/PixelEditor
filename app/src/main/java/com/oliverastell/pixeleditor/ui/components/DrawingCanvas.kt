...
import com.oliverastell.pixeleditor.ui.painter.EditorPainter
...
fun DrawingCanvas(
    ...
    val oneFingerInput = oneFingerInput@{ event: PointerEvent ->
        ...
        val topLeftOfCanvasReal = Offset(
            centerOfFrameReal.x - appState.editor!!.width*zoom/2 + pan.x - topLeftOfFrameReal.x,
            centerOfFrameReal.y - appState.editor!!.width*zoom/2 + pan.y - topLeftOfFrameReal.y
        )
    ...
    Box(
        modifier = modifier
            ...
            .onGloballyPositioned { coordinates ->
                ...
                centerOfFrameReal = Offset(
                    topLeftOfFrameReal.x + size.width / 2,
                    topLeftOfFrameReal.y + size.height / 2
                )
            }
            .pointerInput(Unit) {
        ...
        appState.editor.changed
        Image(
            painter = EditorPainter(appState.editor),
