...
@Composable
fun PalettePanel(appState: EditorAppState, maxHeight: Float) {
    ...
    RevealingUserPanel(
        ...
        draggerContent = {
            ...
            LazyHorizontalGrid (
                ...
                items(appState.editor.textures.size) { textureIdx ->
                    TextureSwitch(
                        appState,
                        texture = appState.loader.getTexture(appState.editor.textures[textureIdx])!!,
                        modifier = Modifier
